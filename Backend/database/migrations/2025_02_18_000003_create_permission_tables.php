...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], static function (Blueprint $table) {
            // $table->engine('InnoDB');
            $table->bigIncrements('id'); // permission id --> Viene por defecto como BIGINT
            $table->string('name')->nullable(false)->unique();   
            $table->string('guard_name'); // Opción pordefecto, no borrar, se utiliza para gestionar roles y permisos.
            $table->timestamps();
        ...
        Schema::create($tableNames['role_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotRole, $pivotPermission) {
            ...
            $table->dateTime('assing_date')->nullable(false);
        });
