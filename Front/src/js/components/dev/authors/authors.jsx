...
const Authors = () => {
  return (
    <ul className="list bg-base-100 rounded-box shadow-md">
      <li className="p-4 pb-2 text-xs opacity-60 tracking-wide">Autores más activos esta semana</li>
      ...
      <li className="list-row">
        ...
        <div className="list-col-grow">
          <div>Dio Lupa</div>
          <div className="text-xs uppercase font-semibold opacity-60">Deportes</div>
        </div>
      ...
      <li className="list-row">
        ...
        <div className="list-col-grow">
          ...
          <div className="text-xs uppercase font-semibold opacity-60">Tecnología</div>
        </div>
        {/*<button className="btn btn-square btn-ghost">
          <svg className="size-[1.2em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor">
      ...
      <li className="list-row">
        ...
        <div className="list-col-grow">
          ...
          <div className="text-xs uppercase font-semibold opacity-60">Recetas</div>
        </div>
        {/*<button className="btn btn-square btn-ghost">
          <svg className="size-[1.2em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor">
